(()=>{
  ...
  const dimensions={
    ...
    '2006-memory-bronze-black':['S 32x34x44cm'],
    ...
    '2008-999-9-bronze-black-white-gold-leaf':['24x28x33cm'],
    ...
    '2009-dream-stainless-steel':['57x42x35cm'],
    '2009-new-continent-bronze-black-white':['63x49x45cm'],
    '2009-message-bronze-gold-leaf':['55x70x176cm'],
    '2009-pride-of-heaven-bronze-black-gold-leaf':['37x32x57cm','112x91x173cm'],
    '2010-wow-stainless-steel':['28x28x32cm'],
    '2014-little-mischief-stainless-steel':['48x43x50cm'],
    '2017-bad-temper-bronze-black-gold':['42x58x62cm','63x87x93cm'],
    ...
    '2018-gelato-bronze-black-silver':['15x15x22cm'],
    '2018-gelato-bronze-black-white':['15x15x22cm'],
    '2018-gelato-bronze-white-gold':['15x15x22cm'],
    ...
    '2018-spirit-bronze-black':['20x6x7cm','54x20x17cm'],
    '2018-spirit-bronze-black-silver':['20x6x7cm','54x20x17cm'],
    '2018-spirit-bronze-lake-green':['20x6x7cm','54x20x17cm'],
    '2018-spirit-bronze-white':['20x6x7cm','54x20x17cm'],
    '2018-spirit-bronze-white-gold':['20x6x7cm','54x20x17cm'],
    '2018-spirit-stainless-steel':['20x6x7cm','54x20x17cm'],
    '2019-small-bronze-black':['小黑 20x16x29cm','獵物 34x17x19cm'],
    '2019-small-stainless-steel':['小黑 20x16x29cm','獵物 34x17x19cm'],
  ...
  const pageUrl=work=>'works/'+work[2]+'.html?v=20260914b';
