(()=>{
  const workStyle=document.createElement('link');workStyle.rel='stylesheet';workStyle.href='assets/works-overrides.css?v=20260910y';document.head.append(workStyle);
  const catalog=[
  ...
  const pageUrl=work=>'works/'+work[2]+'.html?v=20260910y';
